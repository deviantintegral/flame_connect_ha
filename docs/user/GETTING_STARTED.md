# Getting Started with FlameConnect

This guide will help you install and set up the FlameConnect custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/deviantintegral/flameconnect_ha`
6. Set category to "Integration"
7. Click "Add"
8. Find "FlameConnect" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/deviantintegral/flameconnect_ha/releases)
2. Extract the `flameconnect` folder from the archive
3. Copy it to `custom_components/flameconnect/` in your Home Assistant configuration directory
...
4. Select entities from "FlameConnect"
...
- Report issues at [GitHub Issues](https://github.com/deviantintegral/flameconnect_ha/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/deviantintegral/flameconnect_ha/discussions)
