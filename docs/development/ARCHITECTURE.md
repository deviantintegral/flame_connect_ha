...
│   ├── __init__.py          # Exports FlameConnectDataUpdateCoordinator
...
│   ├── __init__.py          # Exports FlameConnectEntity
...
- `base.py` - Main coordinator class (`FlameConnectDataUpdateCoordinator`)
...
**Key class:** `FlameConnectDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `FlameConnectApiClient`
...
- `FlameConnectConfigFlowHandler` (main flow)
- `FlameConnectOptionsFlow` (options)
...
**Key class:** `FlameConnectEntity` (in `entity/base.py`)
...
2. `FlameConnectEntity` for common functionality
...
3. Create entity classes inheriting from platform base + `FlameConnectEntity`
