...
Find all entities in **Settings** → **Devices & Services** → **FlameConnect** → click on the device.
...
```yaml
service: flameconnect.example_action
data:
  # Add your parameters here
```

### `flameconnect.reload_data`
...
```yaml
service: flameconnect.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → FlameConnect → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@deviantintegral][user_profile]**
