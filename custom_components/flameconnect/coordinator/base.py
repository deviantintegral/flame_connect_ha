...
from custom_components.flameconnect.api import (
...
class DeviantintegralDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: DeviantintegralConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except DeviantintegralApiClientAuthenticationError as exception:
