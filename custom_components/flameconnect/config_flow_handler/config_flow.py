...
if TYPE_CHECKING:
    from custom_components.flameconnect.config_flow_handler.options_flow import DeviantintegralOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "DeviantintegralApiClientAuthenticationError": "auth",
    "DeviantintegralApiClientCommunicationError": "connection",
}


class DeviantintegralConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    ...
    def async_get_options_flow(
        ...
        return DeviantintegralOptionsFlow()
...
__all__ = ["DeviantintegralConfigFlowHandler"]
