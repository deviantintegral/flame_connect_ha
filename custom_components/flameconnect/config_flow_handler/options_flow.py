...
from custom_components.flameconnect.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class DeviantintegralOptionsFlow(config_entries.OptionsFlow):
    """
...
__all__ = ["DeviantintegralOptionsFlow"]
