...
class DeviantintegralApiClientError(Exception):
    """Base exception to indicate a general API error."""


class DeviantintegralApiClientCommunicationError(
    DeviantintegralApiClientError,
):
    """Exception to indicate a communication error with the API."""


class DeviantintegralApiClientAuthenticationError(
    DeviantintegralApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        DeviantintegralApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise DeviantintegralApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class DeviantintegralApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            DeviantintegralApiClientAuthenticationError: If authentication fails.
            DeviantintegralApiClientCommunicationError: If communication fails.
            DeviantintegralApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise DeviantintegralApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise DeviantintegralApiClientError(
                msg,
            ) from exception
