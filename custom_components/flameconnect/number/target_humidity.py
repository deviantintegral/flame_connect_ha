"""Target humidity number for flameconnect."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.flameconnect.api import DeviantintegralApiClientError
from custom_components.flameconnect.const import LOGGER
from custom_components.flameconnect.entity import DeviantintegralEntity
from homeassistant.components.number import NumberDeviceClass, NumberEntity, NumberEntityDescription, NumberMode
from homeassistant.const import PERCENTAGE
from homeassistant.exceptions import HomeAssistantError

if TYPE_CHECKING:
    from custom_components.flameconnect.coordinator import DeviantintegralDataUpdateCoordinator
...
class DeviantintegralHumidityNumber(NumberEntity, DeviantintegralEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        except DeviantintegralApiClientError as exception:
