"""Binary sensor platform for flameconnect."""
...
from .connectivity import ENTITY_DESCRIPTIONS as CONNECTIVITY_DESCRIPTIONS, DeviantintegralConnectivitySensor
from .filter import ENTITY_DESCRIPTIONS as FILTER_DESCRIPTIONS, DeviantintegralFilterSensor
...
async def async_setup_entry(
    ...
    connectivity_entities = [
        DeviantintegralConnectivitySensor(
