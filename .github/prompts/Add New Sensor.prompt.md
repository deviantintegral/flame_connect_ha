...
- Create new sensor file in `custom_components/flameconnect/sensor/`
- Inherit from `DeviantintegralEntity` and `SensorEntity`
...
```python
"""[Sensor description] for FlameConnect."""
...
class Deviantintegral[SensorName]Sensor(
...
- Entity: `custom_components/flameconnect/sensor/[sensor_name].py`
- Platform: `custom_components/flameconnect/sensor/__init__.py`
- Translations: `custom_components/flameconnect/translations/*.json`
