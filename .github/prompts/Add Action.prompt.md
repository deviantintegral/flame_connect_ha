...
**File:** `custom_components/flameconnect/services.yaml`
...
Create `custom_components/flameconnect/service_actions/[action_name].py`:

```python
"""[Action name] service action for FlameConnect."""
...
**File:** `custom_components/flameconnect/__init__.py`
...
**File:** `custom_components/flameconnect/const.py`
...
3. Find service action: `flameconnect.[action_name]`
...
- **Domain:** `flameconnect`
- **Service actions directory:** `custom_components/flameconnect/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/flameconnect/services.yaml` (legacy filename)
- **Icons:** `custom_components/flameconnect/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/flameconnect/translations/*.json` under `services` key (legacy)
