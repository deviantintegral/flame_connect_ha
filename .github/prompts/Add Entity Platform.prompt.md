...
**Directory:** `custom_components/flameconnect/[platform]/`
...
```python
"""[Platform] platform for FlameConnect."""
...
from .entity import DeviantintegralEntity
from .[entity_file] import Deviantintegral[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: DeviantintegralDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            Deviantintegral[EntityName](coordinator, entry),
...
```python
"""[Entity description] for FlameConnect."""
...
class Deviantintegral[EntityName](
    DeviantintegralEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/flameconnect/manifest.json`:
...
- [ ] Entity class inherits from both `DeviantintegralEntity` and platform class
...
- **Domain:** `flameconnect`
- **Class prefix:** `Deviantintegral`
- **Base entity:** `DeviantintegralEntity` in `entity/base.py`
- **Coordinator:** `DeviantintegralDataUpdateCoordinator`
