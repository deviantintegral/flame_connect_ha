...
- Inherit from `DeviantintegralEntity` and platform base class
...
- Entity: `custom_components/flameconnect/[platform]/[entity_name].py`
- Platform: `custom_components/flameconnect/[platform]/__init__.py`
