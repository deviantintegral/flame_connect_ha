...
- **`entity/`** - Base entity classes (inherit `DeviantintegralEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, DeviantintegralEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import DeviantintegralEntity`
