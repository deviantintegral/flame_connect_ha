...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Deviantintegral`
...
- Inherit from both platform entity and `DeviantintegralEntity` (order matters)
...
**Config entry data:** `entry_data: DeviantintegralData = hass.data[DOMAIN][entry.entry_id]`
