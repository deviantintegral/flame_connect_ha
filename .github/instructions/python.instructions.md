...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `FlameConnect`
...
- Inherit from both platform entity and `FlameConnectEntity` (order matters)
...
**Config entry data:** `entry_data: FlameConnectData = hass.data[DOMAIN][entry.entry_id]`
