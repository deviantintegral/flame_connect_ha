...
- **Main code:** `custom_components/flameconnect/`
...
- `entity/` — Base entity class (`DeviantintegralEntity`)
...
- Entity MRO: `(PlatformEntity, DeviantintegralEntity)` — order matters
...
- Debug level: `custom_components.flameconnect: debug` in `config/configuration.yaml`
